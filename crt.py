...
class Crt(object):
    ...
    def gotoXY(self, x, y):
        ...
        """
        self.write(lib.colorama.ansi.Cursor(x, y))
    ...
    def keyPressed(self):
        '''
            Keypressed scans the keyboard buffer and sees if a key has been
            pressed. If this is the case, True is returned. If not,
    ...
    def textMode(self, mode):
        '''
            TextMode sets the textmode of the screen (i.e. the number of lines and columns of
            the screen). The lower byte is use to set the VGA text mode.
            TBD
        '''
        pass
